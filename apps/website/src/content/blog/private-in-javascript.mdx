---
title: "Privacy in JavaScript: Native Private Properties and Methods with Hashtags"
description: "JavaScript now allows developers to declare private methods and properties directly using a hashtag (#), enabling native privacy without relying on TypeScript."
author: "Nicolas Molina (@nicobytes)"
date: "2024-10-14"
heroImage: "/blog/private-in-js/80-blog.jpg"
