...
date: "2024-04-18"
coverImage: "./og.jpg"
ogImage: "/imgs/og/blog/responsive-views-in-angular-with-defer.jpg"
categories: ["Angular"]
draft: false
...
<ArticleImage src={responsiveDesktopImg} alt="responsive desktop view" />

And when the app runs on mobile screens, the app loads a different component based on cards.

<ArticleImage src={responsiveMobileImg} alt="responsive mobile view" />
...
<ArticleImage src={screen1Img} alt="bundle size with if approach" />
...
<ArticleImage src={screen2Img} alt="bundle size with defer approach" />
...
<ArticleImage src={chartImg} alt="bundle size comparison chart" />
