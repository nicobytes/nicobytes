...
date: "2024-04-18"
heroImage: "/blog/responsive-views/og.jpg"
categories: ["Angular"]
draft: false
...
![responsive desktop view](/blog/responsive-views/resposive_desktop.jpg)

And when the app runs on mobile screens, the app loads a different component based on cards.

![responsive mobile view](/blog/responsive-views/resposive_mobile.jpg)
...
![bundle size with if approach](/blog/responsive-views/screen_1.png)
...
![bundle size with defer approach](/blog/responsive-views/screen_2.png)
...
![bundle size comparison chart](/blog/responsive-views/chart.png)
