...
date: "2020-06-30"
title: "Lulla AI"
description: "On-device TensorFlow.js audio classification for baby sleep patterns — edge ML on Ionic/Angular with real-time inference and sleep insights for parents."
coverImage: "./lulla-ai.jpg"
ogImage: "/imgs/og/portfolio/lulla-ai.jpg"
url: "https://lullaai.com/"
type: "private"
---

import ArticleImage from "../../../components/ArticleImage.astro";
import nightModeImg from "./lulla_ai_night_mode.jpg";
import logsImg from "./lulla_ai_logs.jpg";
...
<ArticleImage src={nightModeImg} alt="Lulla AI night mode" />
...
<ArticleImage src={logsImg} alt="Lulla AI sleep logs" />
