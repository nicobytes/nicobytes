...
description: "Scaled Platzi’s AI tutor (Ada) to 6,000+ concurrent learners on serverless Cloudflare Workers, with LangChain, GPT-4, and RAG for context-aware support."
image: "./chat_ada.jpg"
...
import codeRecommendationsImg from "./chat_ada_code.jpg";
import themesImg from "./chat_ada_themes.jpg";
import classRecommendationsImg from "./chat_ada_classes.jpg";
...
<ArticleImage src={codeRecommendationsImg} alt="Platzi AI Chat code recommendations" />
...
<ArticleImage src={themesImg} alt="Platzi AI Chat themes" />
...
<ArticleImage src={classRecommendationsImg} alt="Platzi AI Chat class recommendations" />
