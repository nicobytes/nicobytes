...
description: "In-browser coding environment running Python via Pyodide (WebAssembly), SQL, and JavaScript in secure sandboxes with automated challenge validation."
coverImage: "./playground.jpg"
ogImage: "/imgs/og/portfolio/platzi-playground.jpg"
...
import pythonImg from "./playground_py.jpg";
import sqlImg from "./playground_sql.jpg";
import javascriptImg from "./playground_js.jpg";
...
<ArticleImage src={pythonImg} alt="Platzi playground Python" />
...
<ArticleImage src={sqlImg} alt="Platzi playground SQL" />
...
<ArticleImage src={javascriptImg} alt="Platzi playground JavaScript" />
